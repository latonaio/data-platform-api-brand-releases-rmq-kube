...
import (
	"context"
	dpfm_api_input_reader "data-platform-api-brand-releases-rmq-kube/DPFM_API_Input_Reader"
	dpfm_api_output_formatter "data-platform-api-brand-releases-rmq-kube/DPFM_API_Output_Formatter"
	"data-platform-api-brand-releases-rmq-kube/config"
...
func (c *DPFMAPICaller) headerRelease(
	...
	header.IsReleaseled = input.Brand.IsReleaseled
	res, err := c.rmq.SessionKeepRequest(nil, c.conf.RMQ.QueueToSQL()[0], map[string]interface{}{"message": header, "function": "BrandHeader", "runtime_session_id": sessionID})
	if err != nil {
